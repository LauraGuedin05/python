...
@app.route('/')
def curriculo():
    nome_pessoa = "Henrique Santos Tavares"
    email_contato = "henriquestv18@gmail.com"
    telefone_contato = "(31) 98527-1685"
    instagram_handle = "@henriquesantostv"
    escola_nome = "Escola Técnica do COTEMIG"
    ...
    etiquetas_tecnologias = "".join([
        f'<div style="padding: 8px 14px; background: #f3f3f3; border-radius: 8px;">{tecnologia}</div>' 
    ...
    <head>
        <meta charset="UTF-8">
        <title>Currículo - {nome_pessoa}</title>
        <style>
    ...
    <body>
        <div align="center" style="padding: 20px;">
          <h1 style="margin-bottom: 5px;">👋 {nome_pessoa}</h1>
        ...
        <section style="max-width: 900px; margin: auto; padding: 20px;">
          <h2>🚀 Sobre mim</h2>
          <p>
            Tenho 17 anos e sou estudante da <strong>{escola_nome}</strong>, atualmente atuando na área de tecnologia.
          ...
          <h2>📫 Contato</h2>
          <ul>
            <li>📧 Email: <a href="mailto:{email_contato}">{email_contato}</a></li>
            <li>📸 Instagram: <a href="https://instagram.com/henriquesantostv">{instagram_handle}</a></li>
            <li>📱 WhatsApp: <a href="https://wa.me/5531985271685">{telefone_contato}</a></li>
            <li>💼 LinkedIn: <a href="#">{nome_pessoa}</a></li>
          </ul>
        </section>
